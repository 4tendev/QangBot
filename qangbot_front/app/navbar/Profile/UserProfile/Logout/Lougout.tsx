...
const Lougout = () => {
  ...
  return (
    ...
    <button
      onClick={logout}
      className="flex items-center justify-between h-full btn shadow-none  btn-sm rounded-none w-full px-4 text-rose-600"
    >
      <div>{dictionary["logout"][lang]}</div>
      {fetching === false ? (
        <svg
